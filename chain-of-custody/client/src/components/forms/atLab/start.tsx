        ...
        <Flex direction="column" width="100%" justify="space-between" spacing={4}>
          <Box marginY="20px">
            <Heading fontSize="13pt">
              PLEASE CONFIRM BELOW TO ACKNOWLEDGE THAT THIS SAMPLE HAS BEEN RECEIVED BY:
            </Heading>
          </Box>
          <Stack>
            <Text fontSize="13pt">{submittedLab?.customAttributes?.companyName || 'NOT AVAILABLE'}</Text>
            ...
            <Button marginTop="20px" maxW="100vw" onClick={() => nextStep()} bgColor="#B4C7E7" color="gray.700">
              Confirm
            </Button>
          </Stack>
        </Flex>
