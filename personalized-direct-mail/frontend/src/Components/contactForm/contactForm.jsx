...
const ChildContactForm = (props) => {
  ...
  const { register, handleSubmit } = useForm({
    defaultValues: {
      ...
      city: defaultValues.mailingAddress.city,
    ...
    <Box w="100%" paddingY="30px" bgColor="gray.700">
      <Box display={submitted ? 'none' : 'block'} textColor="white" maxW="700px" marginBottom="60px" marginX="auto">
        <form action="submit" onSubmit={handleSubmit(submit)}>
          ...
          <FormControl marginY="10px" id="firstName" isRequired>
          ...
          <FormControl marginY="10px" id="lastName" isRequired>
          ...
          <FormControl marginY="10px" id="city" isRequired>
          ...
          <FormControl marginY="10px" id="postalOrZip" isRequired>
          ...
          <FormControl marginY="10px" id="phoneNumber" isRequired>
